...
| `v2/` | **New v2 work (kept separate from the upstream tree)** |
...
New development lives entirely under [`v2/`](v2/), kept separate from the original
numbered folders so upstream history stays intact and can still be merged.

| Phase | Folder | Status |
|---|---|---|
| 0 - Bring-up & diagnostics | [`v2/setup/`](v2/setup/) | guides + connection check |
| 1 - Face-tracking webcam | [`v2/webcam-follow/`](v2/webcam-follow/) | Python app, tests pass |
| 2 - Zephyr head firmware | [`v2/firmware/electronbot-zephyr/`](v2/firmware/electronbot-zephyr/) | code-complete, protocol tests pass |
| 3 - RTOS servo firmware | [`v2/firmware/servodrive-zephyr/`](v2/firmware/servodrive-zephyr/) | reference fw, control tests pass |

See [`v2/README.md`](v2/README.md) for the full overview and what is verified vs.
pending hardware.
